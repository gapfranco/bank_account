defmodule Encryption.AESTest do
  ...
  test "can still decrypt the value after adding a new encryption key" do
    ...
    original_keys = Application.get_env(:bank_account, BankAccount.AES)[:keys]

    # add a new key
    Application.put_env(:bank_account, BankAccount.AES,
    ...
    Application.put_env(:bank_account, BankAccount.AES, keys: original_keys)
  end
end
